...
// The code defines a local function named `findDuplicates` that
// takes a table `t` as input. Inside the function, two empty tables
// `duplicates` and `seen` are created.
